...
path_to_chrome = os.path.join(os.path.dirname(__file__), "selenium/webdriver", "chrome/chromedriver")

email = 'carlotta.arianna.karin@gmail.com'
password = 'Camerini2015'
